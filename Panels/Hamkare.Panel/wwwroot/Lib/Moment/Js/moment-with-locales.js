;(function (global, factory) {
    ...
    function set(config) {
        ...
        // Todoo: Remove "ordinalParse" fallback in next major release.
    ...
    function loadLocale(name) {
        var oldLocale = null,
            aliasedRequire;
        // Todoo: Find a better way to register and load all the locales in Node
        if (
    ...
    function checkWeekday(weekdayStr, parsedInput, config) {
        if (weekdayStr) {
            // Todoo: Replace the vanilla JS Date object with an independent day-of-week check.
    ...
    function dayOfYearFromWeekInfo(config) {
        ...
        if (w.GG != null || w.W != null || w.E != null) {
            ...
            // Todoo: We need to take the current isoWeekYear, but that depends on
    ...
    function configFromStringAndFormat(config) {
        // Todoo: Move this to another part of the creation flow to prevent circular deps
    ...
    // Todoo: remove 'name' arg after deprecation is removed
    ...
    hooks.defineLocale('fr', {
        ...
        ordinal: function (number, period) {
            switch (period) {
                // Todoo: Return 'e' when day of month > 1. Move this case inside
