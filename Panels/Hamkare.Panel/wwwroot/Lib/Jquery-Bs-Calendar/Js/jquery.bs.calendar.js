    ...
    $.fn.bsCalendar = function (options, params = null) {
        ...
        function drawCalendar(containerElement, selectedDate = null) {
            ...
            calendar.forEach(week => {
                ...
                // calendar week
                $('<div>', {
                    class: 'd-flex justify-_content-center align-items-center js-cal-row bootstrap-calendar-week',
                    css: {
                ...
                week.days.forEach(day => {
                    ...
                    let col = $('<div>', {
                        ...
                        class: 'position-relative d-flex justify-_content-center align-items-center bootstrap-calendar-day ' + highlight + cellBackground,
                        css: {
            ...
            if (!events.length) {
                ...
                events.forEach(event => {
                    ...
                    let eventWrapper = $('<div>', {
                        class: 'js-event d-flex justify-_content-between align-items-center list-group-item p-0',
