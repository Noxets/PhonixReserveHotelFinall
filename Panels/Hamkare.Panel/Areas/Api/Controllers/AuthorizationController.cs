...
//
// public class AuthorizationController(UserManager<User> userManager) : ApiController
// {
//     /// <summary>
//     /// 
//     /// </summary>
...
//
//     [HttpGet("{id}")]
//     public virtual async Task<IActionResult> Get([FromRoute] string id, CancellationToken cancellationToken = default)
//     {
